...
export default {
    ...
    return {
      projects: [{
        ...
        deliverables: [
          ...
          'Navigation bar',
          'Point tracker',
          "Results based on user's answer choices", // eslint-disable-next-line
          'Responsive design'
        ],
        projectFeatures: [{
          ...
          description: "After every question answered, a tally is kept based on the user's choices and the results are displayed on the final slide.", // eslint-disable-next-line
          video: 'project-1/results.mp4'
        }, {
          title: 'Responsive Design',
          description: "Content positioning based on the user's viewport size.", // eslint-disable-next-line
  ...
  methods: {
    ...
    getImgUrl (image) {
      return require('../../assets/img/page-10/' + image)
    }
  },
  mounted: function () {
